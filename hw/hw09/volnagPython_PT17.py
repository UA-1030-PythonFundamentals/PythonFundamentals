...
##and from it the randint() function) -- HW09-PT17----July 14,2023

import random


num_rand = random.randint(1,100) #Gererating random integer 
...
while i < 10:
  ...
  if num == num_rand:
    ...
    print("This number is LESS then the target number.")
  elif num >= num_rand:
